...
public class OrderFlowTestButtonUp extends Main {


    private By orderButtonUp = By.xpath("//button[@class='Button_Button__ra12g']"); // Локатор кнопки "Заказать" вверху страниы
